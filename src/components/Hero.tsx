  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 text-center">
        ...
        {/* Subtitle */}
        <p className="text-xl max-w-4xl mx-auto mb-16 leading-relaxed font-poppins sm:text-xl text-gray-50">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-24">
          <Button size="lg" className="text-lg px-10 py-6 h-auto font-semibold rounded-full">
            Start Recording
            <ArrowRight className="ml-3 w-6 h-6" />
          </Button>
          <Button variant="outline" size="lg" className="text-lg px-10 py-6 h-auto font-semibold rounded-full">
            See How It Works
          </Button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-5xl mx-auto">
          <div className="flex flex-col items-center text-center">
            <div className="w-20 h-20 bg-primary/10 rounded-3xl flex items-center justify-center mb-6 shadow-lg border border-primary/20">
              <Mic className="w-10 h-10 text-primary" />
            </div>
            <h3 className="text-xl font-semibold mb-4 font-poppins">Record Your Idea</h3>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-semibold mb-4 font-poppins">AI Optimization</h3>
            <p className="text-muted-foreground text-lg leading-relaxed">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-semibold mb-4 font-poppins">Perfect Pitch Deck</h3>
            <p className="text-muted-foreground text-lg leading-relaxed">
